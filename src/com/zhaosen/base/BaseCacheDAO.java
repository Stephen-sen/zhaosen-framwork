...
public class BaseCacheDAO<T> {
    ...
    public List<?> getSQLPageList(final String sql, final List<Object> values, final Class<?> beanClass, final List<String> fieldList, final int firstResult, final int maxResults) {
        return (List)this.getHibernateTemplateNotCache().execute(new HibernateCallback() {
            public List<?> doInHibernate(Session session) throws HibernateException {
    ...
    public Integer getSQLCount(final String sql, final List<Object> values) {
        return (Integer)this.getHibernateTemplateNotCache().execute(new HibernateCallback() {
            public Object doInHibernate(Session session) throws HibernateException, SQLException {
                SQLQuery query = session.createSQLQuery(sql);
                query.setCacheable(false);
                if(values != null) {
    ...
    public HibernateTemplate getHibernateTemplateNotCache() {
        return this.hibernateTemplate;
    }
